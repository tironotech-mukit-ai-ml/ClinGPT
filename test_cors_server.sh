...
echo "TEST 1: CORS preflight from server IP (REDACTED:8005)"
curl -v \
  -H "Origin: http://REDACTED:8005" \
...
echo "Expected header: Access-Control-Allow-Origin: http://REDACTED:8005"
